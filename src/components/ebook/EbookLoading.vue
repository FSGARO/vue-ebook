...
<template>
  <div class="ebook-loading">
    <div class="ebook-loading-wrapper">
      <div :key="index" class="ebook-loading-item" v-for="(item, index) in data">
        <div :key="subIndex" class="ebook-loading-line-wrapper" v-for="(subItem, subIndex) in item">
          <div class="ebook-loading-line" ref="line"></div><!--线-->
          <div class="ebook-loading-mask" ref="mask"></div><!--蒙版-->
        </div>
      </div>
